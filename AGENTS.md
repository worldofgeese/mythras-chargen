...
4. Track and claim work through `decapod todo`; do not mutate `.decapod/*` directly.
5. All git-tracked implementation work MUST happen inside a Decapod Docker/container workspace. Use `decapod workspace ensure --container` or `decapod auto container run`.
